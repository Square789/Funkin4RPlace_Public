...
class FunkinHscript extends InterpEx {
    ...
    public function new(path:String) {
        ...
        variables.set('AchievementManager', AchievementManager);
		...
		variables.set('version', MainMenuF4rpState.psychEngineVersion.trim());
		variables.set('versionExtra', MainMenuF4rpState.psychEngineExtraVersion.trim());
